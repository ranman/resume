...
\item
   ...
   \begin{itemize}
      \resitem{Managed Continuous Integration (buildbot, jenkins, travis) across multiple platforms (FreeBSD, Windows, Linux, OSX).}
...
\item
   ...
   \begin{itemize}
      \resitem{Graduated with Honors. Dean's list every year. Selected for special recognition by the faculty out of 450 students. High scores on SAT/ACT/AP exams.}
   \end{itemize}
\end{itemize}
\pagebreak
\resheading{Skills}
